...
public class TripExpensesController {
    ...
    public Result addExpense(@RequestParam UUID userId, 
    ...
    public Result batchAddExpenses(@RequestParam UUID userId,
                                 @RequestParam UUID tripId,
    ...
    public Result updateExpense(@RequestParam UUID userId,
    ...
    public Result deleteExpense(@RequestParam UUID userId, @RequestParam UUID expenseId) {
    ...
    public Result getExpenseById(@RequestParam UUID userId, @RequestParam UUID expenseId) {
    ...
    public Result getExpensesByTripId(@RequestParam UUID userId, @RequestParam UUID tripId) {
    ...
    public Result getTotalExpenseStatisticsByTripId(@RequestParam UUID userId, @RequestParam UUID tripId) {
    ...
    public Result getCategoryExpenseStatisticsByTripId(@RequestParam UUID userId, @RequestParam UUID tripId) {
