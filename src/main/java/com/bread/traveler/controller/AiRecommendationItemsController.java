...
public class AiRecommendationItemsController {
    ...
    public Result getPoisItems(
            ...
            UUID conversationId, 
            @Schema(description = "是否为手动添加", example = "false") 
    ...
    public Result addPois(
            ...
            @Schema(description = "POI ID列表", example = "[\"123e4567-e89b-12d3-a456-426614174002\", \"123e4567-e89b-12d3-a456-426614174003\"]") 
            @RequestParam List<UUID> poiIds) {
    ...
    public Result addNonPois(
            ...
            @Schema(description = "会话ID", example = "123e4567-e89b-12d3-a456-426614174001") 
            @RequestParam UUID conversationId, 
            @Schema(description = "非POI项ID列表", example = "[\"123e4567-e89b-12d3-a456-426614174004\", \"123e4567-e89b-12d3-a456-426614174005\"]") 
            @RequestParam List<UUID> nonPoiItemIds) {
    ...
    public Result removePoisFromItems(
            ...
            @Schema(description = "会话ID", example = "123e4567-e89b-12d3-a456-426614174001") 
            UUID conversationId, 
            @Schema(description = "POI ID列表", example = "[\"123e4567-e89b-12d3-a456-426614174002\"]") 
            @RequestParam(required = false) List<UUID> poiIds) {
    ...
    public Result removeNonPoisFromItems(
            ...
            @Schema(description = "会话ID", example = "123e4567-e89b-12d3-a456-426614174001") 
            UUID conversationId, 
            @Schema(description = "非POI项ID列表", example = "[\"123e4567-e89b-12d3-a456-426614174004\"]") 
            @RequestParam(required = false) List<UUID> nonPoiItemIds) {
