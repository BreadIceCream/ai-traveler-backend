...
public class TripMembersController {
    ...
    public Result handleMemberRequest(
            @Schema(description = "旅程ID", example = "123e4567-e89b-12d3-a456-426614174001") 
            @RequestParam UUID tripId, 
            @Schema(description = "处理的用户ID", example = "123e4567-e89b-12d3-a456-426614174002") 
            @RequestParam UUID handleUserId, 
            @Schema(description = "当前用户ID", example = "123e4567-e89b-12d3-a456-426614174000") 
            @RequestParam UUID currentUserId, 
            @Schema(description = "是否接受", example = "true") 
    ...
    public Result inviteMember(
            ...
            @Schema(description = "用户ID", example = "123e4567-e89b-12d3-a456-426614174000") 
            @RequestParam UUID userId, 
            @Schema(description = "被邀请用户ID列表", example = "[\"123e4567-e89b-12d3-a456-426614174003\", \"123e4567-e89b-12d3-a456-426614174004\"]") 
            @RequestParam List<UUID> inviteUserIds){
