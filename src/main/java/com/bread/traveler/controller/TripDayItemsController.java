...
public class TripDayItemsController {
    ...
    public Result getEntireItemsByTripDayId(@RequestParam UUID userId, @RequestParam UUID tripId, @RequestParam UUID tripDayId) {
    ...
    public Result addItems(@RequestParam UUID userId, @RequestParam UUID tripId,
                           @RequestParam UUID tripDayId, @RequestParam UUID entityId,
    ...
    public Result deleteItems(@RequestParam UUID userId, @RequestParam UUID tripId, @RequestParam List<UUID> itemIds) {
    ...
    public Result updateItemInfo(@RequestParam UUID userId, @RequestParam UUID tripId, @RequestBody TripDayItemDto dto) {
    ...
    public Result updateTransportNote(@RequestParam UUID userId, @RequestParam UUID tripId, @RequestParam UUID itemId, @RequestParam(required = false) String originAddress) {
    ...
    public Result moveItemOrder(
            @RequestParam UUID userId, @RequestParam UUID tripId,
